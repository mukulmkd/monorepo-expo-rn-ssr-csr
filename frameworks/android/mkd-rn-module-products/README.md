...
Android AAR framework for ModuleProducts React Native module.

## Overview

This framework contains:
- Pre-bundled JavaScript code (module-products.bundle)
...
```gradle
dependencies {
    implementation files('libs/mkd-rn-module-products-release.aar')
}
```
...
dependencies {
    implementation 'com.yourorg.products:ModuleProductsFramework:1.0.0'
}
```
...
```kotlin
import com.yourorg.products.ModuleProductsFramework
...
- `getInstance(): ModuleProductsFramework` - Get singleton instance
...
`src/main/assets/module-products.bundle`

This bundle was created from the latest version published to Verdaccio.

## Version

Generated from: @app/module-products
