 ...
 * 
 * Android framework wrapper for ModuleProducts React Native module.
 * 
 * This class provides a simple API to load and render the ModuleProducts module
 * in any Android Activity or Fragment.
 * 
 * Usage:
 * ```kotlin
 * val framework = ModuleProductsFramework.getInstance()
 ...
 * ```
 */
class ModuleProductsFramework private constructor() {
    
    companion object {
        private const val TAG = "ModuleProductsFramework"
        private const val BUNDLE_NAME = "module-products.bundle"
        private const val MODULE_NAME = "ModuleProducts"
        
        @Volatile
        private var INSTANCE: ModuleProductsFramework? = null
        
        /**
         * Get the singleton instance of ModuleProductsFramework
         */
        fun getInstance(): ModuleProductsFramework {
            return INSTANCE ?: synchronized(this) {
                INSTANCE ?: ModuleProductsFramework().also { INSTANCE = it }
            }
        }
    }
    
    /**
     * Gets the bundle file path for the ModuleProducts module
     * 
     * @param context Android context
     * @return The absolute path to the module-products.bundle file, or null if not found
     */
     ...
     * 
     * @return The registered module name ("ModuleProducts")
     */
