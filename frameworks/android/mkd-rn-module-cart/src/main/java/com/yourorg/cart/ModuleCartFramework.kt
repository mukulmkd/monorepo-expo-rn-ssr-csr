 ...
 * ModuleCartFramework
 * 
 * Android framework wrapper for ModuleCart React Native module.
 * 
 * This class provides a simple API to load and render the ModuleCart module
 ...
 * ```
 */
class ModuleCartFramework private constructor() {
    
    companion object {
        private const val TAG = "ModuleCartFramework"
        private const val BUNDLE_NAME = "module-cart.bundle"
        private const val MODULE_NAME = "ModuleCart"
        
        @Volatile
        private var INSTANCE: ModuleCartFramework? = null
        
        /**
         * Get the singleton instance of ModuleCartFramework
         */
        fun getInstance(): ModuleCartFramework {
            return INSTANCE ?: synchronized(this) {
                INSTANCE ?: ModuleCartFramework().also { INSTANCE = it }
            }
        }
    }
    
    /**
     * Gets the bundle file path for the ModuleCart module
     * 
     * @param context Android context
     * @return The absolute path to the module-cart.bundle file, or null if not found
     */
     ...
     * 
     * @return The registered module name ("ModuleCart")
     */
