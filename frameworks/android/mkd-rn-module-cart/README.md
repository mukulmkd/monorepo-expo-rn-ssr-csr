...
```gradle
dependencies {
    implementation files('libs/mkd-rn-module-cart-release.aar')
}
```
...
dependencies {
    implementation 'com.yourorg.cart:ModuleCartFramework:1.0.0'
}
```
...
```kotlin
import com.yourorg.cart.ModuleCartFramework
