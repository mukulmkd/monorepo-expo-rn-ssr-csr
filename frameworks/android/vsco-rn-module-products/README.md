...
```gradle
dependencies {
    implementation files('libs/vsco-rn-module-products-release.aar')
}
```
...
dependencies {
    implementation 'com.vscorp.products:ModuleProductsFramework:1.0.0'
}
```
...
```kotlin
import com.vscorp.products.ModuleProductsFramework
