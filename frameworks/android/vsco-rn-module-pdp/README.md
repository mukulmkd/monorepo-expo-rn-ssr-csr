...
```gradle
dependencies {
    implementation files('libs/vsco-rn-module-pdp-release.aar')
}
```
...
dependencies {
    implementation 'com.vscorp.pdp:ModulePDPFramework:1.0.0'
}
```
...
```kotlin
import com.vscorp.pdp.ModulePDPFramework
