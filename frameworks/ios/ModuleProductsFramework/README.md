...
iOS SPM framework for ModuleProducts React Native module.
...
In Xcode:
1. File → Add Package Dependencies → Add Local...
2. Navigate to: `frameworks/ios/ModuleProductsFramework`
3. Add to target
...
if let rootView = ModuleProductsFramework.shared.createView() {
...
let bundleURL = ModuleProductsFramework.shared.getBundleURL()
...
`Resources/module-products.bundle`
