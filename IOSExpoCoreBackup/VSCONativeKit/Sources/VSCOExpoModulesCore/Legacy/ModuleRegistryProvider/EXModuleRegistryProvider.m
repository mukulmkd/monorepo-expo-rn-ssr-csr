...
void (^EXinitializeGlobalModulesRegistry)(void) = ^{
  ...
  // EXFileSystemLegacyUtilities is a Swift class, use runtime lookup
  Class fileSystemLegacyUtilitiesClass = NSClassFromString(@"EXFileSystemLegacyUtilities");
  if (fileSystemLegacyUtilitiesClass) {
    [EXModuleClasses addObject:fileSystemLegacyUtilitiesClass];
  }
};
