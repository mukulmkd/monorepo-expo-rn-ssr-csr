...
// Set up react namespace - conditionally based on available headers.
// Important: we always forward-declare `facebook::react::CallInvoker` because some distributions
// make `TurboModuleUtils.h` available (or shimmed) without exposing `CallInvoker.h`.
#ifdef __cplusplus
